...
public class TaskServiceTest {
    ...
    public void invalidID() {
        Task task = new Task("0000000002x", "Playing", "Fortnite");
        addTask(task);
        System.out.println("size: " + tasks.size());
    }
    ...
    public void invalidName() {
        Task task = new Task("0000000002", "Playing Playing Playing Playing Playing Playing Playing", "Fortnite");
        addTask(task);
        System.out.println("size: " + tasks.size());
    }
    ...
    public void invalidDescription() {
        Task task = new Task("0000000002", "Playing", "Fortnite Fortnite Fortnite Fortnite Fortnite");
        addTask(task);
        System.out.println("size: " + tasks.size());
    }
    ...
    public void updateTask() {
        Task task = new Task("0000000001", "Yelling", "A curse");
        update(task);
